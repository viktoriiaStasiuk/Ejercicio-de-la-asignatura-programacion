        ...
        do {
            ...
            switch (opcionMenu) { 
                ...
                case 3:
                    ...
                    System.out.print("Duración: ");
                    String duracionCadena = s.nextLine();
                    if (!duracionCadena.isEmpty()){  
                        duracion = Integer.parseInt(duracionCadena);
                ...
                case 4:
                    ...
                    if (!album.contains(new Disco(codigo, "", "", "", 0))) {
                        ...
                        System.out.println("Album borrado del listado correctamente.");
                    }
            }
